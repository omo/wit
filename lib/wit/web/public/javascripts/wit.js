...
WIT.NoteView = function() {
  ...
  this.shortcut = new WIT.Shortcut($(document.body));
  this.shortcut.add("E", true, this.moveToEdit.bind(this));
  this.shortcut.add("O", true, this.moveToNew.bind(this));
};

WIT.NoteView.prototype.moveToEdit = function() {
  window.location = this.editLinkEl.prop("href");
};

WIT.NoteView.prototype.moveToNew = function() {
  window.location = this.newLinkEl.prop("href");
};
